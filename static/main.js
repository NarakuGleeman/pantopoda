...
function until($timestamp) {
    var $difference = $timestamp - Date.now() / 1000 | 0,
        $num;
    switch (true) {
        case ($difference < 60):
...
function ago($timestamp) {
    var $difference = (Date.now() / 1000 | 0) - $timestamp,
        $num;
    switch (true) {
        case ($difference < 60):
            return "" + $difference + ' ' + _('second(s)');
...
var selectedstyle = 'yotsuba.css';
var styles = {

    'Yotsuba B': '',
    'Yotsuba': '/stylesheets/yotsuba.css',
    '经典主题': '/stylesheets/yotsuba.css',
    '夜间模式': '/stylesheets/dark.css',
...
var post_date = "%y年%m月%d日(%a) %H:%M:%S";
var max_images = 1;
